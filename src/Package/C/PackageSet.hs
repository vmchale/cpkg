...
defaultPackageSetDhall Nothing      = input auto "https://raw.githubusercontent.com/vmchale/cpkg/master/pkgs/pre-pkg-set.dhall (λ(_ : types.BuildVars) → env:HOME as Text)"
